...
- 🌱 I'm experienced in ... GenAI, AgenticAI, ML, LangGraph, Cloud data Analytics with Bigquery, python, pandas, API's, Data Governance, DataLake architechture, Web Scraping with beautilfulSoup, Selenium Splinters, Data Analysis with PostgreSQL, SQLite, MongoDB, python SQLAlchemy, python Flask API, Web Development with HTML, CSS, BootStrap, JavaScript, Data Visualization with Looker Studio, Looker, Tableau, Jquery.js, D3.js, leaflet.js, and plotly.js.
